...
repr::concreteFactory::concreteFactory(std::shared_ptr<repr::view> _playerView) : playerView(_playerView) {}
...
std::shared_ptr<world::player> repr::concreteFactory::producePlayer() {
    ...
    std::shared_ptr<repr::viewEntity> model = std::make_shared<repr::viewEntity>(name, cam, 0.1);
